...
int main()
{
	...
	do {
		...
		room.checkPlayerBlock();
		room.setPlayerActed(false);
		while (!room.hasPlayerActed()) {
			if (_getch() == 224) {
				switch (_getch()) {
				case 75: room.movePlayerLeft(); break;
				case 77: room.movePlayerRight(); break;
				case 72: room.movePlayerUp(); break;
				case 80: room.movePlayerDown(); break;
				}
			}
		}
